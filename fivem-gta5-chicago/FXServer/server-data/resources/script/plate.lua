--- IMAGE CONFIG HERE ---
imageUrl = "https://i.imgur.com/jGZCwtF.png" -- Paste your image URL here (doesn't have to be from imgur)
...
local object = CreateDui('https://imgur.com/nktms9A.png', 540, 300) -- this URL doesn't need to be edited, its just the 2d model for the plate -- Load image into object
local handle = GetDuiHandle(object) -- Gets DUI handle from object
